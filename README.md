  ...
  <table>
    <tr>
      <td align="center" width="33%">
        ...
        <br>
        <sub><strong>SmokeSegmenter</strong> — Semi-automated smoke segmentation using SAM</sub>
      </td>
      <td align="center" width="33%">
  ...
  <table>
    <tr>
      ...
      <td align="center" width="33%">
        ...
        <br>
        <sub><strong>Rigorous Mathematics</strong> — Proof of the Dominated Convergence Theorem for the Lebesgue integral, developed in alignment with Axler's: Measure, Integration & Real Analysis (2022) book [5].</sub>
      </td>
    </tr>
  </table>
</div>
