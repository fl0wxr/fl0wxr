...
| [`netfieldv1`](https://github.com/fl0wxr/netfieldv1) | Derived, vectorized and implemented the backpropagation algorithm from scratch (NumPy/CuPy) for any LeNet-like CNN architecture |
