  ...
  <table>
    <tr>
      <td valign="top" align="center" width="33%">
        ...
        <br>
        <sub><strong>SmokeSegmenter</strong>: Semi-automated smoke segmentation utility based on the Segment Anything Model (SAM). Initially, SAM transforms bounding boxes to segmentation masks in bulk, then the human conveniently approves/denies the masks one-by-one -- thus eliminating a significant overhead from the workflow of generating high quality segmentation masks.</sub>
      </td>
      <td valign="top" align="center" width="33%">
